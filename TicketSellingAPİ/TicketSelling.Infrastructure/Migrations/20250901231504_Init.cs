        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Last4Digits = table.Column<int>(type: "int", nullable: true),
                    Encoded16Digits = table.Column<int>(type: "int", nullable: true),
                    EncodedCvc = table.Column<int>(type: "int", nullable: true),
                    EncodedExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EncodedCardHolderName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiftRewards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GiftRewards_Users_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSavedCard_CardDetails_CardDetailsId",
                        column: x => x.CardDetailsId,
                        principalTable: "CardDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedCard_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchesSectorPrice", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchesSectorPrice_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchesSectorPrice_Sectors_SectorId",
                        column: x => x.SectorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentDetail_CardDetails_CardDetailsId",
                        column: x => x.CardDetailsId,
                        principalTable: "CardDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchesSectorPrice_MatchId",
                table: "MatchesSectorPrice",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchesSectorPrice_SectorId",
                table: "MatchesSectorPrice",
                column: "SectorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetail_CardDetailsId",
                table: "PaymentDetail",
