...
public class CrudManagerWithoutUpdate<TEntity, TDto, TCreateDto> : ICrudServiceWithoutUpdate<TEntity, TDto, TCreateDto> where TEntity : BaseEntity
{
    private readonly IRepository<TEntity> _repository;
    private readonly IMapper _mapper;

    public CrudManagerWithoutUpdate(IRepository<TEntity> repository)
    {
